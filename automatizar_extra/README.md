...
Está etapa para mim é a mais simples pois será apenas criar um job no MS SQL Agent adicionantodos os script criados até aqui.

Segue o script de criação do job.
````
USE [msdb]
GO
